...
export default function StreamId({currentId, currentListeners}) {
    ...
    return (
        <div style={{ width: "100%", display: "flex", alignItems: "flex-start", flexFlow: "column", paddingBottom: "20px", marginBottom: "20px", borderBottom: "1px solid #b8b8b8" }}>
            ...
            <Typography style={{ fontSize: "14px", margin: "15px 0", width: "50%"  }}>La direccion diaria de la transmision de radio consiguela <a href="http://frontina1003fm.radio12345.com/">aqui</a></Typography>
            <form id="streamid" style={{ width: "50%"}} onSubmit={handleSubmit}>
                ...
                <Typography style={{ fontSize: "12.5px", margin: "15px 0", width: "100%", color: "#7a7a7a" }}>Es necesario, que cada vez que se inicia la transmision desde Listen2MyRadio, copiar la direccion y pegarla aqui.</Typography>
